...
class SQtree {
 ...
 public:
  ...
  void renderHelper(PNG &png, Node * curr);
 ...
 private:
  ...
  void copyHelper(Node *& newRoot, const Node * oldRoot);
  ...
  void buildTreeHelper(stats & s, double tol, Node *& curr);

  // double fourSplit(stats & s, pair<int,int> & ul, int xOffset, int yOffset, int w, int h);
  // double horizontalSplit(stats & s, pair<int,int> & ul, int xOffset, int yOffset, int w, int h);
  // double verticalSplit(stats & s, pair<int,int> & ul, int xOffset, int yOffset, int w, int h);

  double maxVar(double vNW, double vNE, double vSW, double vSE);
